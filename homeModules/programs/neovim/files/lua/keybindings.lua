...
vim.keymap.set('n', '<leader>da', ":DapDisasm<CR>")
vim.keymap.set('n', '<leader>dc', ":DapContinue<CR>")
vim.keymap.set('n', '<leader><Enter>', require("dap").run_to_cursor)
...
vim.keymap.set('n', '<leader>v', ":DapViewToggle<CR>")
vim.keymap.set('n', '<leader>k', ":lua require('dap.ui.widgets').hover()<CR>")
