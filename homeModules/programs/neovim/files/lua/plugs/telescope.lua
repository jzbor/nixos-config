...
vim.api.nvim_set_keymap('n', '<leader>sf', [[<cmd>lua require('telescope.builtin').find_files({previewer = false, hidden = false})<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>s.', [[<cmd>lua require('telescope.builtin').find_files({previewer = false, hidden = true})<CR>]], { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<leader>sd', [[<cmd>Telescope file_browser path=%:p:h select_buffer=true<CR>]], { noremap = true })
